...
public class Tutorial
{
    ...
    int section; // if this tutorial bellongs to all lectures in a section then this is the section number (-1 if not)
    int[] parent_lectures; // the ids of the associated lecture of this tutorial
    ...
    {
        System.out.print(String.format("TUT: %s %d %d, id: %d, lec_id: %d, ", course_descriptor, lec_num, tut_num, id, lec_num));
